...
```
cd existing_repo
git remote add origin https://gitlab.com/gojoc/boospringbootdata.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/gojoc/boospringbootdata/-/settings/integrations)
